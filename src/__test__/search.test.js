...
describe("createSearchQuery", () => {
  test("search query too long - length should trim", () => {
    expect(
      createSearchQuery({
        query:
      ...
      `"path:*.txt 12345678901234567890123451234567890123456789012345123456789012345678901234512345678901234567890123451234567890123456789012345123456789012345678901234512345678901234567890123451234567890123456789012345123456789012345678901234512345678901234"`
    );
  });
